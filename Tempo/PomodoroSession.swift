...
//  Tempo
//
//  Session state machine for iOS. Ported from WatchPomodoroSession
//  with full 4-pomodoro cycle support. Uses absolute timestamps
//  so remaining time is always derived, never drifts.
//
